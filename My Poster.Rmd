...
As we can see from Figure 4 and 5, the majority of our data seems to come from one order, the Passeriformes. Because of this, we decided to focus on just this group.
